...
class YaUploader:
    ...
    # отдельный вопрос у меня вызывает request.put , когда в документации полигона post. Как и почему оно работает о_0... 
    # put подсмотрел у лектора. Еще вопрос: open в реквесте не закроет файл сам, да? (в коммитах есть вариант с ним)
    # https://cloud.yandex.ru/docs/storage/s3/api-ref/object/upload - они поменяли методы для загрузки файла.-> PUT
